                        ...
                        <div class="app-page-title">
                                ...
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Total Calls</div>
                                            <div class="widget-subheading">Last week records</div>
                                        </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-grow-early">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Campaigns</div>
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            ...
                                                                            <div class="widget-subheading">Agent</div>
                                                                        </div>
                                                                        <div class="widget-content-right">
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            ...
                                                                            <div class="widget-subheading">Team Lead</div>
                                                                        </div>
                                                                        <div class="widget-content-right">
                                                                            <div class="font-size-xlg text-muted">
                                                                                <small class="opacity-5 pr-1"></small>
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            ...
                                                                            <div class="widget-subheading">Supervisor</div>
                                                                        </div>
                                                                        <div class="widget-content-right">
                                                                            <div class="font-size-xlg text-muted">
                                                                                <small class="opacity-5 pr-1"></small>
                                            ...
                                            <div class="widget-chart p-3">
                                                ...
                                                <div class="widget-chart-content text-center mt-5">
                                                    <div class="widget-description mt-0 text-warning">
                                                        ...
                                                        <span class="text-muted opacity-8 pl-1">increased resources</span>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="widget-content">
                                                            <div class="widget-content-outer">
                                                                <div class="widget-content-wrapper">
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="text-muted opacity-6">Submitted Tickets</div>
                                                                    </div>
                                                                </div>
                                                                <div class="widget-progress-wrapper mt-1">
                                                                    <div class="progress-bar-sm progress-bar-animated-alt progress">
